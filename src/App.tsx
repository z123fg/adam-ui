  ...
  return (
    <div className="App">
      ...
      <div className = "mylink">
        ...
        <MyLink href={"https://www.google.com"}>{"Default href to google without target='_blank'"}</MyLink>
        <MyLink target={"_blank"} href={"https://www.google.com"}>{"Default href to google with target='_blank'"}</MyLink>
